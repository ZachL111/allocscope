...
allocscope is a C project for systems programming. It focuses on this technical goal: Explore arena allocation, alignment, guard checks, and fragmentation reports.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 153, risk penalty 6, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
