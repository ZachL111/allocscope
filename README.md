...
`allocscope` treats systems programming as a local verification problem. The C implementation is intentionally narrow, but the fixtures and notes make the behavior explicit.

## Allocscope Checkpoints
