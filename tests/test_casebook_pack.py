"""Regression checks for the allocscope casebook."""
...
from casebook.harness import assert_expected, allocscope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(allocscope_summary(), assert_expected())
