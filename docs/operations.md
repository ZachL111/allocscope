...
`allocscope` is centered on systems programming work in C. The technical target is: Explore arena allocation, alignment, guard checks, and fragmentation reports.
...
The score is deterministic. The current threshold is 153. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 2.
